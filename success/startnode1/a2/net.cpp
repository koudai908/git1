...
{
    qDebug() << "ThreadOpenConnections2 started\n";
    ...
    loop
    {
        ...
        {
            qDebug() << "addrman.size()==0 && (GetTime() - nStart > 60) && !fTestNet true! pass!" << endl;
        ...
        {
            qDebug() << "addrman.size()==0 && (GetTime() - nStart > 60) && !fTestNet false! reject!" << endl;
        }
        ...
        qDebug() << "Choose an address to connect started! " << endl;
